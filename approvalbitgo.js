...
const main = async () => {
    ...
    console.log(`Amount: ${amount} BGERH`);
    console.log(`To: ${bger.address}`);

    const transaction = await bitGoWallet.send({
        data: approvalTx.data, amount: `${tokenAmount}`, address: PAIR_ADDRESS,
