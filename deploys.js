...
async function main() {
  ...
  const approveTx1 = await usdt.approve(routerAddress, MaxUint256, {gasLimit: 300000});
  await approveTx1.wait();
  const approvalTx2 = await usdc.approve(routerAddress, MaxUint256, {gasLimit: 300000});
