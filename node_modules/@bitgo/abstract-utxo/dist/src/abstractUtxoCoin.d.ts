...
import { CrossChainRecoverySigned, CrossChainRecoveryUnsigned, RecoveryProvider, backupKeyRecovery, RecoverParams, V1RecoverParams, v1BackupKeyRecovery, V1SweepParams, v1Sweep } from './recovery';
...
export declare type Output = BaseOutput | WalletOutput;
export declare function isWalletOutput(output: Output): output is WalletOutput;
